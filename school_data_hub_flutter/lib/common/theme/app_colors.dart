...
class AppColors {
  ...
  static const selectedCardColor = Color.fromARGB(
    255,
    255,
    220,
    168,
  ); // Color.fromARGB(255, 197, 212, 255);
  //button colors
  ...
  static const koerperWahrnehmungMotorikColor = Color.fromARGB(
    255,
    156,
    76,
    149,
  ...
  static const schooldayEventReasonChipUnselectedColor = Color.fromARGB(
    255,
    248,
    162,
    93,
  );
  static const Color schooldayEventReasonChipSelectedColor = Color.fromARGB(
    255,
    239,
    137,
    13,
