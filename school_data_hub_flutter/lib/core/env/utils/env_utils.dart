...
class EnvUtils {
  static Future<void> generateNewEnvKeys({
    ...
    required HubRunMode hubRunMode,
  }) async {
    ...
    if (selectedDirectory != null) {
      ...
      final schoolKeyFile = File(
        '$selectedDirectory/school_key_$serverName.txt',
      );
  ...
  getDeviceNameAndId() async {
    ...
    if (Platform.isWindows) {
      ...
      return (deviceName: androidInfo.model, deviceId: androidInfo.id);
    } else if (Platform.isIOS) {
      final iosInfo = await deviceInfo.iosInfo;
      return (deviceName: iosInfo.name, deviceId: iosInfo.modelName);
    } else if (Platform.isLinux) {
      final linuxInfo = await deviceInfo.linuxInfo;
      return (deviceName: linuxInfo.prettyName, deviceId: linuxInfo.id);
      ...
      return (deviceId: 'Unknown Device', deviceName: 'Unknown Device');
    }
  }
}
