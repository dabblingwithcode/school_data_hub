...
class LoginPage extends WatchingWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // If authenticated, the router will handle redirection to /home
    // We just show a loading indicator here or let the router take over
    if (isAuthenticated) {
              ...
              children: [
                ...
                keyboardOn
                    ...
                    : const SizedBox(
                        ...
                        width: 250,
                        child: Image(
                          image: AssetImage('assets/schuldaten_hub_logo.png'),
                        ),
                      ),
                const Gap(20),
                Text(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          await confirmationDialog(
                            ...
                            message: locale.areYouSureYouWantToDeleteSchoolKey,
                          );
