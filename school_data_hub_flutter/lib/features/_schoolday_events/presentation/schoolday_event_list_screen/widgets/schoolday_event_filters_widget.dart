...
/// Use with [CommonPupilFiltersWidget] in [FilterSheet] filterList.
class SchooldayEventFiltersWidget extends WatchingWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(children: [Text('Ereignisse', style: context.typography.subtitle.bold)]),
        ...
        Row(children: [Text('Grund', style: context.typography.subtitle.bold)]),
        Gap(Style.spacing.xs),
        Wrap(
          spacing: Style.spacing.xs,
          crossAxisAlignment: WrapCrossAlignment.center,
        ...
        Gap(Style.spacing.sm),
        Row(children: [Text('Sortieren', style: context.typography.subtitle.bold)]),
        Gap(Style.spacing.xs),
        Wrap(
          spacing: Style.spacing.xs,
          crossAxisAlignment: WrapCrossAlignment.center,
