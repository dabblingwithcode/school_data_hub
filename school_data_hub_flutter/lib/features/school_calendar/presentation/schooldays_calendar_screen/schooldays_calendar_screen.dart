...
import 'package:school_data_hub_flutter/features/school_calendar/presentation/schooldays_calendar_screen/widgets/schoolday_calendar_day_cell.dart';
import 'package:table_calendar/table_calendar.dart';

class SchooldaysCalendarScreen extends WatchingWidget {
  const SchooldaysCalendarScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          TappableIcon(
            icon: Icon(Icons.today, color: style.colors.background),
            tooltip: 'Heute',
            onPressed: () {
          ...
          if (AuthClearanceHelper.isAdmin())
            TappableIcon(
              icon: Icon(Icons.add, color: style.colors.background),
              tooltip: 'Schultage hinzuf\u00fcgen',
              onPressed: () async {
            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: Container(color: style.colors.canvas),
                    ...
                    child: CardBox(
                      ...
                      child: TableCalendar<String>(
                        ...
                        headerStyle: HeaderStyle(
                          titleCentered: true,
                          titleTextStyle: context.typography.subtitle.bold,
                        ),
