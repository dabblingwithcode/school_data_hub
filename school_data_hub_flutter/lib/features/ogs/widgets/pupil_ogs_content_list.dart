    ...
    Row(
      children: [
        ...
        InkWell(
          ...
          child: Text(pupil.pickUpTime ?? 'keine',
    ...
    InkWell(
      onTap: () async {
        ...
        await di<PupilManager>().updateStringProperty(
            pupilId: pupil.internalId, property: 'afterSchoolCareInfo', value: ogsInfo);
      },
      onLongPress: () async {
        ...
        await di<PupilManager>().updateStringProperty(
            pupilId: pupil.internalId, property: 'afterSchoolCareInfo', value: null);
      },
      child: Row(
        children: [
          Flexible(
