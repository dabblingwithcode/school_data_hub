...
import 'package:school_data_hub_flutter/features/competence/presentation/pupil_competence_list_page/widgets/pupil_competence_checks/competence_card.dart';
import 'package:school_data_hub_flutter/features/competence/presentation/pupil_competence_list_page/widgets/pupil_competence_checks/competence_check_card.dart';
  ...
  for (Competence competence in competences) {
    ...
    if (pupilCompetenceChecksMap.containsKey(competence.publicId)) {
      ...
      if (filteredChecks.isNotEmpty) {
        final totalStatus =
            filteredChecks.map((check) => check.score).reduce((a, b) => a + b);
                    ...
                    children: [
                      CompetenceCard(
                        ...
                        competenceChecks: pupilCompetenceChecksMap
                                .containsKey(competence.publicId)
                            ? [
