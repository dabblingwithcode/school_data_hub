...
class CompetenceHelper {
  ...
  //         .where((element) => element.publicId == publicId)
  //         .toList();
  ...
  //     if (competenceChecksMap[competenceCheck.publicId] == null) {
  //       competenceChecksMap[competenceCheck.publicId] = [];
  //     }
  //     // add the competence check to the list of the competence checks of the competence
  //     competenceChecksMap[competenceCheck.publicId]!.add(competenceCheck);
  ...
  //       getCompetenceChecksMappedTopublicIdsForThisPupil(pupil.internalId);
  //   int count = 0;
