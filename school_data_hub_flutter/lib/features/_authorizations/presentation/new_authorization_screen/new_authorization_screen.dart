...
class NewAuthorizationScreen extends StatefulWidget {
  const NewAuthorizationScreen({super.key});

  @override
  NewAuthorizationScreenState createState() => NewAuthorizationScreenState();
}

class NewAuthorizationScreenState extends State<NewAuthorizationScreen> {
