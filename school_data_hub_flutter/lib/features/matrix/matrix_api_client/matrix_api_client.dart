...
class MatrixApiClient {
  ...
  MatrixApiClient(this._dio, {String? baseUrl}) {
    _dio
      //..options.baseUrl = baseUrl
      ..options.connectTimeout = MatrixApiSettings.connectionTimeout
      //..options.headers['content-Type'] = 'application/json'
      ..options.validateStatus = (status) {
        return status! < 500;
      }
      ..options.receiveTimeout = MatrixApiSettings.receiveTimeout;
...
class MatrixApiException implements Exception {
  ...
  MatrixApiException(this.message, int? statusCode)
