...
class MatrixRoomEditScreen extends WatchingStatefulWidget {
  ...
  const MatrixRoomEditScreen({required this.room, super.key});

  @override
  State<MatrixRoomEditScreen> createState() => _MatrixRoomEditScreenState();
}

class _MatrixRoomEditScreenState extends State<MatrixRoomEditScreen> {
