...
class SetMatrixEnvironmentScreen extends WatchingWidget {
  const SetMatrixEnvironmentScreen({super.key});
...
class _FlagsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Richtlinien-Flags', style: context.typography.subtitle.bold),
        const Gap(8),
        _flagSwitch(
...
class _HooksSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Hooks', style: context.typography.subtitle.bold),
        const Gap(8),
        ...
        Wrap(
          ...
          runSpacing: 8,
          children: [
            Button.small(onPressed: vm.addHook, label: 'Hook hinzufügen'),
            Button.small(
              onPressed: () async {
                await vm.applyPolicyHooks();
              },
              label: 'Hooks speichern',
            ),
          ],
        ),
      ],
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Text(title, style: context.typography.body.w600),
                ),
                IconButton(
                ...
                ExpansionHeader(
                  ...
                  switchColor: Style.of(context).colors.foreground,
                ),
              ],
            ),
          ),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: Text('Match rules', style: context.typography.body.w600),
            ),
            TextButton.icon(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(
          children: [
            Expanded(child: Text('Rule', style: context.typography.body.w600)),
            IconButton(
