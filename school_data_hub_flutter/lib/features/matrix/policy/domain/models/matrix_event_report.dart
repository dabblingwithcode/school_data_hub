class MatrixReportedEvent {
  ...
  factory MatrixReportedEvent.fromJson(Map<String, dynamic> json) {
    return MatrixReportedEvent(
...
class MatrixEventReportsResponse {
  final List<MatrixReportedEvent> reportedEvents;
  final int? nextToken;
  final int total;

  const MatrixEventReportsResponse({
    required this.reportedEvents,
  ...
  factory MatrixEventReportsResponse.fromJson(Map<String, dynamic> json) {
    final reports =
        (json['event_reports'] as List<dynamic>? ?? const <dynamic>[])
            ...
            .map(MatrixReportedEvent.fromJson)
            .toList();

    return MatrixEventReportsResponse(
      reportedEvents: reports,
...
class MatrixEventReportDetail extends MatrixReportedEvent {
