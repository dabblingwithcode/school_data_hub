...
MatchRules _$MatchRulesFromJson(Map<String, dynamic> json) =>
    MatchRules(
      key: (json['type'] ?? json['key']) as String?,
      regex: json['regex'] as String?,
    );

Map<String, dynamic> _$MatchRulesToJson(MatchRules instance) =>
    <String, dynamic>{'type': instance.key, 'regex': instance.regex};

RESTServiceRequestHeaders _$RESTServiceRequestHeadersFromJson(
  Map<String, dynamic> json,
) => RESTServiceRequestHeaders(authorization: json['authorization'] as String?);
...
Hook _$HookFromJson(Map<String, dynamic> json) => Hook(
  ...
  rejectionErrorCode: json['rejectionErrorCode'] as String?,
  rejectionErrorMessage: json['rejectionErrorMessage'] as String?,
  rESTServiceURL: (json['RESTServiceURL'] ?? json['rESTServiceURL']) as String?,
  rESTServiceRequestHeaders:
      (json['RESTServiceRequestHeaders'] ?? json['rESTServiceRequestHeaders']) ==
          null
      ? null
      : RESTServiceRequestHeaders.fromJson(
          (json['RESTServiceRequestHeaders'] ??
              json['rESTServiceRequestHeaders']) as Map<String, dynamic>,
        ),
  rESTServiceContingencyHook:
      (json['RESTServiceContingencyHook'] ??
              json['rESTServiceContingencyHook']) ==
          null
      ? null
