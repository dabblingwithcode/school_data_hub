...
class MatrixUser extends ChangeNotifier {
  ...
  factory MatrixUser.fromJson(Map<String, dynamic> json) {
    ...
    if (json.containsKey('joinedRoomIds')) {
      ...
      final List<String> roomIds = List<String>.from(
        json['joinedRoomIds'] as Iterable<String>,
      );
  ...
  Map<String, dynamic> toJson() {
    final map = _$MatrixUserToJson(this);
    // Ensure joinedRooms is serialized as list of maps (generated code puts raw List<JoinedRoom>)
    map['joinedRooms'] = _joinedRooms.map((e) => e.toJson()).toList();
    return map;
  }
}
