...
class PupilIdentityStream {
  ...
  StreamSubscription<PupilIdentityDto> encryptedPupilIdsStreamSubscription({
    ...
    Function(String userName)? onReceiverJoined,
    Function(String userName)? onReceiverConnecting,
    Function(String userName)? onReceiverLeft,
    Function(String userName)? onRequestReceived,
    Function()? onRequestConfirmed,
    Function(bool wasAutoRejected)? onRequestRejected,
    Function()? onShouldPopPage,
    Function(String message)? onSenderShutdown,
    Function(int newCount, int totalCount)? onDataReceived,
