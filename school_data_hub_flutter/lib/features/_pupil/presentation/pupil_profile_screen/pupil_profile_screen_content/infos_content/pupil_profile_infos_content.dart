...
import 'package:school_data_hub_flutter/features/_pupil/presentation/pupil_profile_screen/pupil_profile_screen_content/infos_content/widgets/avatar_auth_values.dart';
import 'package:school_data_hub_flutter/features/_pupil/presentation/pupil_profile_screen/pupil_profile_screen_content/infos_content/widgets/pupil_media_auth_values.dart';
        ...
        children: [
          ...
          PupilProfileContentTwoRows(
            ...
            onTap: () {
              if (pupil.contact != null && pupil.contact!.isNotEmpty) {
                MatrixPolicyHelper.launchMatrixUrl(context, pupil.contact!);
              }
            },
            onLongPress: () async {
          ...
          PupilProfileContentTwoRows(
            ...
            onTap: () {
              ...
              if (tutorInfoExists && pupil.tutorInfo!.parentsContact != null) {
            ...
            onLongPress: () async {
              final String? parentsContact = await shortTextfieldDialog(
                ...
                textinField: pupil.tutorInfo?.parentsContact ?? 'keine Angabe',
                context: context,
              );
              ...
              await PupilMutator().updateTutorInfo(
                ...
                tutorInfo: pupil.tutorInfo != null
                    ? pupil.tutorInfo!.copyWith(parentsContact: parentsContact)
                    : TutorInfo(
          ...
          if (pupilSiblings.isNotEmpty)
            ListView.builder(
              ...
              itemBuilder: (context, int index) {
                ...
                return PupilMiniCard(pupil: sibling);
              },
            )
          else
            CardBox(
