...
class MainMenuBottomNavigation extends WatchingWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = createOnce(() => _MainMenuController());
      ...
      handler: (context, value, cancel) {
        if (value.message.isNotEmpty) {
          if (value.type == NotificationType.dialog) {
            ...
            controller.showNotificationBanner(context, value);
          }
        }
      },
    );
    ...
    registerHandler(
      ...
      handler: (context, value, cancel) {
        value
            ? controller.showInstanceLoadingOverlay(context)
    ...
    registerHandler(
      ...
      handler: (context, value, cancel) {
        value
            ? controller.showHeavyLoadingOverlay(context)
            : controller.hideLoadingOverlay();
      },
    );
    ...
    registerHandler(
      ...
      handler: (context, value, cancel) {
        ...
        if (navigationShell.currentIndex != value) {
...
class _MainMenuController implements Disposable {
