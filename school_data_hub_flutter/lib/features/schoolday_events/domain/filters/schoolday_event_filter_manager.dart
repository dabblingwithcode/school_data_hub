      ...
      for (SchooldayEvent schooldayEvent in pupil.schooldayEvents!) {
        ...
        if (activeFilters[SchooldayEventFilter.violenceAgainstPupils]!) {
          if (schooldayEvent.eventReason
              .contains(SchooldayEventReason.violenceAgainstPupils)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.violenceAgainstAdults]!) {
          if (schooldayEvent.eventReason
              .contains(SchooldayEventReason.violenceAgainstTeachers)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.violenceAgainstThings]!) {
          if (schooldayEvent.eventReason
              .contains(SchooldayEventReason.violenceAgainstThings)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.insultOthers]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.insultOthers)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.annoy]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.annoyOthers)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.dangerousBehaviour]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.dangerousBehaviour)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.disturbLesson]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.disturbLesson)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.ignoreInstructions]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.ignoreInstructions)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.learningDevelopmentInfo]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.learningDevelopmentInfo)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.learningSupportInfo]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.learningSupportInfo)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.admonitionInfo]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.admonitionInfo)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
        ...
        if (activeFilters[SchooldayEventFilter.other]!) {
          if (schooldayEvent.schooldayEventReason
              .contains(SchooldayEventReason.other)) {
            isMatched = true;
            complementaryFilter = true;
          } else if (!complementaryFilter) {
            isMatched = false;
