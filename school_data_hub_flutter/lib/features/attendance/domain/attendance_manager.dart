...
class AttendanceManager with ChangeNotifier {
  ...
  Future<void> updateReturnedValue(
    ...
    if (missedSchoolday == null) {
      ...
      if (newMissedSchoolday == null) {
        _log.warning(
          'updateReturnedValue: postMissedSchoolday failed for pupil $pupilId on $date',
        );
        return;
      }
    ...
    if (newValue == true) {
      ...
      if (updatedMissedSchoolday == null) {
        _log.warning(
          'updateReturnedValue: updateMissedSchoolday failed for pupil $pupilId on $date',
        );
        return;
      }
  ...
  Future<void> updateLateTypeValue(
    ...
    if (missedSchoolday == null) {
      ...
      if (updatedMissedSchoolday == null) {
        _log.warning(
          'updateLateTypeValue: postMissedSchoolday failed for pupil $pupilId on $date',
        );
        return;
      }
      updateMissedSchooldayInCollections(updatedMissedSchoolday);
    ...
    if (updatedMissedSchoolday == null) {
      _log.warning(
        'updateLateTypeValue: updateMissedSchoolday failed for pupil $pupilId on $date',
      );
      return;
    }
    updateMissedSchooldayInCollections(updatedMissedSchoolday);
  ...
  Future<void> updateMissedTypeValue(
    ...
    if (missedSchoolday == null) {
      ...
      if (updatedMissedSchoolday == null) {
        _log.warning(
          'updateMissedTypeValue: postMissedSchoolday failed for pupil $pupilId on $date',
        );
        return;
      }
      updateMissedSchooldayInCollections(updatedMissedSchoolday);
    ...
    if (updatedMissedSchoolday == null) {
      _log.warning(
        'updateMissedTypeValue: updateMissedSchoolday failed for pupil $pupilId on $date',
      );
      return;
    }
    updateMissedSchooldayInCollections(updatedMissedSchoolday);
