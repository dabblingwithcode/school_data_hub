      ...
      children: [
        Row(
          children: [
            excusedBadge(false),
            const Gap(5),
            Text('Fehltage', style: context.typography.subtitle.bold),
          ],
        ),
        const Gap(5),
        Row(
        ...
        Row(
          children: [
            ...
            Text(' Verspätungen', style: context.typography.subtitle.bold),
          ],
        ),
        const Gap(5),
        Row(
          children: [
            contactedBadge(1),
            const Gap(5),
            Text('Kontaktiert', style: context.typography.subtitle.bold),
          ],
        ),
        const Gap(5),
        Row(
          children: [
            returnedBadge(true),
            const Gap(5),
            Text('Abgeholt', style: context.typography.subtitle.bold),
          ],
        ),
        ...
        if (isAttendancePage == true)
          Row(
            children: [
              ...
              const Gap(5),
              Text('Familie erreicht', style: context.typography.subtitle.bold),
            ],
          ),
        if (isAttendancePage == true) const Gap(5),
        if (isAttendancePage == true)
