...
class SchoolListHelper {
  ...
  static Map<String, int> schoolListStatsForGivenPupils(
    ...
    final proxyMap = _schoolListManager.getPupilEntriesProxyFromSchoolList(
      schoolList.id!,
    );

    for (final pupil in pupilsInList) {
      final pupilEntryProxy = proxyMap.pupilIdToEntryMap[pupil.pupilId];
      if (pupilEntryProxy != null) {
        final entry = pupilEntryProxy.pupilEntry;
