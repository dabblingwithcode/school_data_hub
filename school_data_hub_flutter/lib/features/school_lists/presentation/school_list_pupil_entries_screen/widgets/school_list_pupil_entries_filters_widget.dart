...
class SchoolListPupilEntriesFiltersWidget extends WatchingWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool valueYesResponse = activeFilters[SchoolListEntryFilter.yesResponse]!;
    bool valueNoResponse = activeFilters[SchoolListEntryFilter.noResponse]!;
    bool valueNullResponse = activeFilters[SchoolListEntryFilter.nullResponse]!;
    bool valueCommentResponse =
        activeFilters[SchoolListEntryFilter.commentResponse]!;

    return Column(
      children: [
        Row(children: [Text('Antwort:', style: context.typography.subtitle)]),
        const Gap(5),
        Wrap(
          spacing: 5,
          ...
          children: [
              ...
              onSelected: (val) {
                if (val) {
                  _schoolListFilterManager.setEntryFilter(
                    entryFilterRecords: [
                      (filter: SchoolListEntryFilter.yesResponse, value: true),
                      (filter: SchoolListEntryFilter.noResponse, value: false),
                      (
                ...
                _schoolListFilterManager.setEntryFilter(
                  entryFilterRecords: [
                    (filter: SchoolListEntryFilter.yesResponse, value: false),
                  ],
                );
              },
            ),
            ThemedFilterChip(
              ...
              onSelected: (val) {
                if (val) {
                  _schoolListFilterManager.setEntryFilter(
                    entryFilterRecords: [
                      (filter: SchoolListEntryFilter.noResponse, value: true),
                      (filter: SchoolListEntryFilter.yesResponse, value: false),
                      (
                        filter: SchoolListEntryFilter.nullResponse,
                        value: false,
            ...
            ThemedFilterChip(
              ...
              onSelected: (val) {
                if (val) {
                  _schoolListFilterManager.setEntryFilter(
                    entryFilterRecords: [
                      (filter: SchoolListEntryFilter.nullResponse, value: true),
                      (filter: SchoolListEntryFilter.yesResponse, value: false),
                      (filter: SchoolListEntryFilter.noResponse, value: false),
                    ],
                  );
            ...
            ThemedFilterChip(
              ...
              onSelected: (val) {
                _schoolListFilterManager.setEntryFilter(
                  entryFilterRecords: [
                    (filter: SchoolListEntryFilter.commentResponse, value: val),
                  ],
                );
              },
            ),
