...
class BookTagSelectionScreen extends StatefulWidget {
  final List<BookTag> allTags;
  final Set<int> selectedTagIds;

  const BookTagSelectionScreen({
    super.key,
  ...
  @override
  State<BookTagSelectionScreen> createState() => _BookTagSelectionScreenState();
}

class _BookTagSelectionScreenState extends State<BookTagSelectionScreen> {
