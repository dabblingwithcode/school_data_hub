          ...
          children: [
            Row(
              ...
              children: [
                ...
                const Spacer(),
                Text('Erstellt von:', style: context.typography.subtitle),
              ...
              children: [
                    ...
                    children: [
                      isAuthorized
                          ...
                          : Padding(
                              ...
                              child: CompetenceCheckIcon(
                                score: competenceCheck.score,
                                size: 60,
                              ),
                            ),
                      Gap(Style.spacing.xs),
                ...
                HubDocumentsSectionWidget(
                  ...
                  onDeleteDocument: (documentId) async {
                    await di<CompetenceManager>().removeFileFromCompetenceCheck(
                      competenceCheckId: competenceCheck.checkId,
