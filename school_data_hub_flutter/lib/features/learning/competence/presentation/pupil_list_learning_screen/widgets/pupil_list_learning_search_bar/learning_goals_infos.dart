...
import 'package:school_data_hub_flutter/features/learning/competence/domain/learning_goals_statistics.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Text((stats.totalGoals).toString(), style: context.typography.title),
        Gap(Style.spacing.lg),
        Text(
          'offen: ',
          style: context.typography.bodySmall.withColor(
