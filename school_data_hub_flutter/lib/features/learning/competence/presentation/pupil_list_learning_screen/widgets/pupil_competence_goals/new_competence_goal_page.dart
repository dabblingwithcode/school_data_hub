...
class NewCompetenceGoalScreen extends StatefulWidget {
  ...
  @override
  State<NewCompetenceGoalScreen> createState() =>
      _NewCompetenceGoalScreenState();
}
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              Gap(Style.spacing.xl),
              Text('Strategien:', style: context.typography.subtitle.bold),
              ...
              if (_isEditMode) ...[
                Gap(Style.spacing.xl),
                Text('Erreicht am:', style: context.typography.subtitle.bold),
                Gap(Style.spacing.sm),
                GestureDetector(
                  onTap: () async {
