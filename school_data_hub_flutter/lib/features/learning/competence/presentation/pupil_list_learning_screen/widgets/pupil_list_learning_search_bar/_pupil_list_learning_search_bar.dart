...
import 'package:school_data_hub_flutter/features/learning/competence/presentation/pupil_list_learning_screen/widgets/pupil_list_learning_search_bar/learning_goals_infos.dart';
import 'package:school_data_hub_flutter/features/learning/competence/presentation/pupil_list_learning_screen/widgets/pupil_list_learning_search_bar/pupil_book_lendings_infos.dart';
import 'package:school_data_hub_flutter/features/learning/competence/presentation/pupil_list_learning_screen/widgets/pupil_list_learning_search_bar/pupil_workbooks_infos.dart';
...
class PupilListLearningSearchBar extends StatelessWidget {
  ...
  const PupilListLearningSearchBar({required this.filtersOn, super.key});
                ...
                GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Icon(
                      Icons.filter_list,
                      color: filtersOn
                          ? Style.of(context).colors.warning
