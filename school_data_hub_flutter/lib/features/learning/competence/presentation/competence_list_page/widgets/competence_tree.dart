...
import 'package:school_data_hub_flutter/features/learning/competence/presentation/competence_list_page/widgets/common_competence_card.dart';
import 'package:school_data_hub_flutter/features/learning/competence/presentation/competence_list_page/widgets/last_child_competence_card.dart';
...
class CompetenceTree extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final children = competences
        .where((c) => c.parentCompetence == parentId)
        .toList()
      ..sort((a, b) {
...
class _CompetenceNode extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color =
        backgroundColor ?? CompetenceHelper.getCompetenceColor(competence.publicId);
