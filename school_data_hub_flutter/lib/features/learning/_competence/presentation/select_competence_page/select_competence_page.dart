...
import 'package:school_data_hub_flutter/features/learning/_competence/presentation/multi_pupil_competence_check_page/multi_pupil_competence_check_page.dart';
...
import 'package:school_data_hub_flutter/features/learning/_competence/presentation/select_competence_page/selectable_competence_tree.dart';
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'Kompetenz auswählen',
            style: context.typography.heading.withColor(style.colors.background),
          ),
        ),
        body: Center(
          heightFactor: 1,
