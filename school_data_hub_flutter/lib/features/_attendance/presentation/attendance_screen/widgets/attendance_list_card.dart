...
import 'package:school_data_hub_flutter/features/_attendance/presentation/attendance_screen/widgets/attendance_dropdown_menu_items.dart';
import 'package:school_data_hub_flutter/features/_attendance/presentation/attendance_screen/widgets/dialogues/late_in_minutes_dialog.dart';
import 'package:school_data_hub_flutter/features/_attendance/presentation/attendance_screen/widgets/dialogues/multiple_entries_dialog.dart';
import 'package:school_data_hub_flutter/features/_attendance/presentation/attendance_screen/widgets/dialogues/returned_time_picker.dart';
...
class AttendanceCard extends WatchingWidget {
      ...
      children: [
        Row(
          ...
          children: [
            ...
            const Gap(8),
            _buildUnexcusedCheckbox(context, info),
            const Gap(4),
            _buildContactedDropdown(context, info, emptyHeight: 45),
            const Gap(4),
            Checkbox(
        ...
        Row(
          children: [
            ...
            _attendanceBadge(
              context,
              'U',
              style.colors.attendanceUnexcused,
              size: 25,
            ),
            const Gap(18),
            _attendanceBadge(
              context,
              'K',
              style.colors.attendanceContactedFailed,
              size: 25,
            ),
            const Gap(19),
            _attendanceBadge(
      ...
      children: [
        ...
        Column(
          children: [
            ...
            _buildUnexcusedCheckbox(context, info),
            const Gap(8),
            _attendanceBadge(context, 'U', style.colors.attendanceUnexcused),
          ],
        ),
        const Gap(5),
        ...
        Column(
          children: [
            const Gap(8),
            _buildContactedDropdown(context, info, emptyHeight: 48),
            const Gap(2),
            _attendanceBadge(
              context,
              'K',
        ...
        Column(
          children: [
            ...
            const Gap(8),
            _attendanceBadge(context, 'H', style.colors.attendanceHome),
  ...
  Widget _buildUnexcusedCheckbox(BuildContext context, AttendanceValues info) {
    final style = Style.of(context);
    return Checkbox(
      checkColor: style.colors.background,
  ...
  Widget _buildInfoRow(BuildContext context, AttendanceValues info) {
    final style = Style.of(context);
    return Padding(
