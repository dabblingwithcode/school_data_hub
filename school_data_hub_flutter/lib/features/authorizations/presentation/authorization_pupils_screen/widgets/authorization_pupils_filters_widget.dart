          ...
          children: [
            ThemedFilterChip(
              ...
              onSelected: (val) {
                if (val) {
                  _authFilterManager.setFilter(
                    authorizationFilters: [
                      ...
                      (
                        authorizationFilter: AuthorizationFilter.nullResponse,
                        value: false,
                      ),
                    ],
                  );
                ...
                _authFilterManager.setFilter(
                  authorizationFilters: [
                    (authorizationFilter: AuthorizationFilter.yes, value: val),
                  ],
                );
              },
            ),
            ThemedFilterChip(
              ...
              onSelected: (val) {
                ...
                _authFilterManager.setFilter(
                  authorizationFilters: [
                    (authorizationFilter: AuthorizationFilter.no, value: val),
                  ],
                );
              },
            ),
            ...
            ThemedFilterChip(
              ...
              onSelected: (val) {
                _authFilterManager.setFilter(
                  authorizationFilters: [
                    (
                      authorizationFilter: AuthorizationFilter.commentResponse,
                      value: val,
                    ),
                  ],
                );
            ...
            ThemedFilterChip(
              ...
              onSelected: (val) {
                _authFilterManager.setFilter(
                  authorizationFilters: [
                    (
                      authorizationFilter: AuthorizationFilter.fileResponse,
                      value: val,
                    ),
                  ],
                );
