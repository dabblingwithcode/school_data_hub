...
class EndpointCompetence extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i5.Competence>> importCompetencesFromJsonFile(
          _i6.File jsonFile) =>
      caller.callServerEndpoint<List<_i5.Competence>>(
        'competence',
        'importCompetencesFromJsonFile',
        {'jsonFile': jsonFile},
      );

  _i2.Future<_i5.Competence> postCompetence({
    int? parentCompetence,
    required String name,
    required List<String> level,
    required List<String> indicators,
  }) =>
      caller.callServerEndpoint<_i5.Competence>(
        'competence',
        'postCompetence',
        {
  ...
  _i2.Future<List<_i5.Competence>> getAllCompetences() =>
      caller.callServerEndpoint<List<_i5.Competence>>(
        'competence',
        'getAllCompetences',
        {},
  ...
  _i2.Future<_i5.Competence> updateCompetence(_i5.Competence competence) =>
      caller.callServerEndpoint<_i5.Competence>(
        'competence',
        'updateCompetence',
...
class EndpointMissedClass extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i7.MissedClass>> getAllMissedClasses() =>
  ...
  _i2.Future<_i7.MissedClass?> getMissedClassesOnDate(DateTime schooldayDate) =>
  ...
  _i2.Future<bool> updateMissedClass(_i7.MissedClass missedClass) =>
      caller.callServerEndpoint<bool>(
        'missedClass',
        'updateMissedClass',
        {'missedClass': missedClass},
...
class EndpointPupil extends _i1.EndpointRef {
  ...
  _i2.Stream<List<_i8.PupilData>> getPupils() =>
      caller.callStreamingServerEndpoint<_i2.Stream<List<_i8.PupilData>>,
          List<_i8.PupilData>>(
        'pupil',
        'getPupils',
        {},
  ...
  _i2.Future<bool> createPupil(_i8.PupilData pupil) =>
      caller.callServerEndpoint<bool>(
        'pupil',
        'createPupil',
        {'pupil': pupil},
  ...
  _i2.Future<void> updateParentInfo(_i9.SiblingsParentInfo parentInfo) =>
      caller.callServerEndpoint<void>(
        'pupil',
        'updateParentInfo',
  ...
  _i2.Future<Set<_i8.PupilData>> refreshPupilDataState(_i6.File file) =>
      caller.callServerEndpoint<Set<_i8.PupilData>>(
        'pupil',
...
class EndpointSchooldayAdmin extends _i1.EndpointRef {
  ...
  _i2.Future<_i10.SchoolSemester> createSchoolSemester(
    DateTime startDate,
    DateTime endDate,
    bool isFirst,
    ...
    DateTime reportSignedDate,
      ...
      caller.callServerEndpoint<_i10.SchoolSemester>(
        'schooldayAdmin',
  ...
  _i2.Future<List<_i10.SchoolSemester>> getAllSchoolSemesters() =>
      caller.callServerEndpoint<List<_i10.SchoolSemester>>(
        'schooldayAdmin',
        'getAllSchoolSemesters',
        {},
      );

  _i2.Future<_i10.SchoolSemester?> getCurrentSchoolSemester() =>
      caller.callServerEndpoint<_i10.SchoolSemester?>(
        'schooldayAdmin',
  ...
  _i2.Future<bool> updateSchoolSemester(_i10.SchoolSemester schoolSemester) =>
      caller.callServerEndpoint<bool>(
        'schooldayAdmin',
  ...
  _i2.Future<bool> deleteSchoolSemester(_i10.SchoolSemester semester) =>
      caller.callServerEndpoint<bool>(
        'schooldayAdmin',
  ...
  _i2.Future<_i11.Schoolday?> createSchoolday(DateTime date) =>
      caller.callServerEndpoint<_i11.Schoolday?>(
        'schooldayAdmin',
        'createSchoolday',
        {'date': date},
      );

  _i2.Future<List<_i11.Schoolday>> createSchooldays(List<DateTime> dates) =>
      caller.callServerEndpoint<List<_i11.Schoolday>>(
        'schooldayAdmin',
        'createSchooldays',
        {'dates': dates},
      );
  ...
  _i2.Future<bool> updateSchoolday(_i11.Schoolday schoolday) =>
      caller.callServerEndpoint<bool>(
        'schooldayAdmin',
        'updateSchoolday',
        {'schoolday': schoolday},
...
class EndpointSchoolday extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i10.SchoolSemester>> getSchoolSemesters() =>
      caller.callServerEndpoint<List<_i10.SchoolSemester>>(
        'schoolday',
        'getSchoolSemesters',
        {},
  ...
  _i2.Future<List<_i11.Schoolday>> getSchooldays() =>
      caller.callServerEndpoint<List<_i11.Schoolday>>(
        'schoolday',
        'getSchooldays',
        {},
...
class EndpointSupportCategory extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i12.SupportCategory>> getSupportCategories() =>
      caller.callServerEndpoint<List<_i12.SupportCategory>>(
        'supportCategory',
        'getSupportCategories',
        {},
      );

  _i2.Future<List<_i12.SupportCategory>> importSupportCategoriesFromJsonFile(
          String jsonFilePath) =>
      caller.callServerEndpoint<List<_i12.SupportCategory>>(
        'supportCategory',
  ...
  _i2.Future<bool> createSupportCategory(_i12.SupportCategory category) =>
      caller.callServerEndpoint<bool>(
        'supportCategory',
  ...
  _i2.Future<bool> updateSupportCategory(_i12.SupportCategory category) =>
      caller.callServerEndpoint<bool>(
        'supportCategory',
  ...
  _i2.Future<bool> deleteSupportCategory(_i12.SupportCategory category) =>
      caller.callServerEndpoint<bool>(
        'supportCategory',
...
class EndpointAuth extends _i1.EndpointRef {
  ...
  _i2.Future<
          ({_i13.DeviceInfo? deviceInfo, _i14.AuthenticationResponse response})>
      login(
    String email,
    String password,
