...
import '../../book/library_book/location/library_book_location.dart' as _i2;
import '../../book/book_tagging/book_tagging.dart' as _i3;

abstract class LibraryBookQuery implements _i1.SerializableModel {
  LibraryBookQuery._({
    this.title,
    this.author,
    this.location,
