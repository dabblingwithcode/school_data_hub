...
class CompetenceReportEndpoint extends Endpoint {
  ...
  Future<CompetenceReport> postCompetenceReport(
    ...
    HubUpdatesTracker.instance.touch(HubObjectType.competenceReport);
    return result;
  }
  ...
  Future<CompetenceReport> updateCompetenceReport(
    ...
    final updated = await CompetenceReport.db.updateRow(session, report);
  ...
  Future<bool> deleteCompetenceReport(
    ...
    session.messages.postMessage(
      'hub_events_stream',
      HubDeleteEvent(
          objectType: HubObjectType.competenceReport, id: report.id!),
    );
    return true;
  }
}
