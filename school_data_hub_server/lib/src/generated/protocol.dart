...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i112.LearningSupportPlan>) {
      return (data as List)
          .map((e) => deserialize<_i112.LearningSupportPlan>(e))
          .toList() as T;
    }
    if (t == List<_i113.SupportCategoryStatus>) {
      return (data as List)
          .map((e) => deserialize<_i113.SupportCategoryStatus>(e))
          .toList() as T;
    }
    if (t == List<_i114.PreSchoolMedical>) {
      return (data as List)
          .map((e) => deserialize<_i114.PreSchoolMedical>(e))
          .toList() as T;
    }
    if (t == _i1.getType<List<_i115.CompulsoryRoom>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i115.CompulsoryRoom>(e))
              .toList()
          : null) as T;
    }
    if (t == List<_i115.CompulsoryRoom>) {
      return (data as List)
          .map((e) => deserialize<_i115.CompulsoryRoom>(e))
          .toList() as T;
    }
    ...
    if (t == List<_i116.SupportLevelLegacyDto>) {
      return (data as List)
          .map((e) => deserialize<_i116.SupportLevelLegacyDto>(e))
          .toList() as T;
    }
    if (t == _i1.getType<({DateTime? value})>()) {
      return (
    ...
    if (t == List<_i117.SchoolList>) {
      return (data as List)
          .map((e) => deserialize<_i117.SchoolList>(e))
          .toList() as T;
    }
    if (t == List<_i118.SchoolSemester>) {
      return (data as List)
          .map((e) => deserialize<_i118.SchoolSemester>(e))
          .toList() as T;
    }
    if (t == List<_i119.SchooldayEvent>) {
      return (data as List)
          .map((e) => deserialize<_i119.SchooldayEvent>(e))
          .toList() as T;
    }
    if (t == List<_i120.Classroom>) {
      return (data as List).map((e) => deserialize<_i120.Classroom>(e)).toList()
          as T;
    }
    if (t == List<_i121.LessonGroup>) {
      return (data as List)
          .map((e) => deserialize<_i121.LessonGroup>(e))
          .toList() as T;
    }
    if (t == List<_i122.ScheduledLesson>) {
      return (data as List)
          .map((e) => deserialize<_i122.ScheduledLesson>(e))
          .toList() as T;
    }
    if (t == List<_i123.ScheduledLessonGroupMembership>) {
      return (data as List)
          .map((e) => deserialize<_i123.ScheduledLessonGroupMembership>(e))
          .toList() as T;
    }
    if (t == List<_i124.Subject>) {
      return (data as List).map((e) => deserialize<_i124.Subject>(e)).toList()
          as T;
    }
    if (t == List<_i125.Timetable>) {
      return (data as List).map((e) => deserialize<_i125.Timetable>(e)).toList()
          as T;
    }
    if (t == List<_i126.TimetableSlot>) {
      return (data as List)
          .map((e) => deserialize<_i126.TimetableSlot>(e))
          .toList() as T;
    }
    if (t == List<_i127.User>) {
      return (data as List).map((e) => deserialize<_i127.User>(e)).toList()
          as T;
    }
    if (t == List<_i128.UserWithDevices>) {
      return (data as List)
          .map((e) => deserialize<_i128.UserWithDevices>(e))
          .toList() as T;
    }
    if (t == List<_i129.PupilWorkbook>) {
      return (data as List)
          .map((e) => deserialize<_i129.PupilWorkbook>(e))
          .toList() as T;
    }
    if (t == List<_i130.Workbook>) {
      return (data as List).map((e) => deserialize<_i130.Workbook>(e)).toList()
          as T;
    }
    if (t == _i1.getType<({int testint, String testString})?>()) {
      return (data == null)
