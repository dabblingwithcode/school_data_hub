...
abstract class SupportGoal
  ...
  factory SupportGoal.fromJson(Map<String, dynamic> jsonSerialization) {
    return SupportGoalImplicit._(
      ...
      goalChecks: (jsonSerialization['goalChecks'] as List?)
          ...
          .toList(),
      $_learningSupportPlanSupportgoalsLearningSupportPlanId: jsonSerialization[
          '_learningSupportPlanSupportgoalsLearningSupportPlanId'] as int?,
  ...
  final int? _learningSupportPlanSupportgoalsLearningSupportPlanId;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (_learningSupportPlanSupportgoalsLearningSupportPlanId != null)
...
class _SupportGoalImpl extends SupportGoal {
  ...
  SupportGoal copyWith({
    ...
    return SupportGoalImplicit._(
      ...
      $_learningSupportPlanSupportgoalsLearningSupportPlanId:
          this._learningSupportPlanSupportgoalsLearningSupportPlanId,
      $_supportCategoryCategorygoalsSupportCategoryId:
...
class SupportGoalImplicit extends _SupportGoalImpl {
  SupportGoalImplicit._({
    ...
    _i3.SupportCategory? supportCategory,
    List<_i4.SupportGoalCheck>? goalChecks,
    int? $_learningSupportPlanSupportgoalsLearningSupportPlanId,
...
class SupportGoalTable extends _i1.Table<int?> {
  SupportGoalTable({super.tableRelation})
    ...
    $_learningSupportPlanSupportgoalsLearningSupportPlanId = _i1.ColumnInt(
      '_learningSupportPlanSupportgoalsLearningSupportPlanId',
      this,
    );
