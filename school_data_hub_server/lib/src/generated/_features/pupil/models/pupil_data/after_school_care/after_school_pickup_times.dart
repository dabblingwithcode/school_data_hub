...
abstract class AfterSchoolCarePickUpTimes
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      if (monday != null) 'monday': monday?.toJsonForProtocol(),
      if (tuesday != null) 'tuesday': tuesday?.toJsonForProtocol(),
      if (wednesday != null) 'wednesday': wednesday?.toJsonForProtocol(),
      if (thursday != null) 'thursday': thursday?.toJsonForProtocol(),
      if (friday != null) 'friday': friday?.toJsonForProtocol(),
    };
  }
