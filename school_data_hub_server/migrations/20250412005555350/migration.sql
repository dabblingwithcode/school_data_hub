...
CREATE TABLE "pupil_data" (
    ...
    "preSchoolMedical" json NOT NULL,
    "kindergarden" text,
    "preSchoolTest" json,
    "avatarId" bigint NOT NULL,
    "avatarAuthId" bigint NOT NULL,
    "publicMediaAuth" json NOT NULL,
    "publicMediaAuthDocumentId" bigint NOT NULL,
    "contact" text,
    "communicationPupil" json,
    "specialInformation" text,
    "pupilDataTutorInfo" json,
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('school_data_hub', '20250412005555350', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250412005555350', "timestamp" = now();
