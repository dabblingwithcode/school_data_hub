...
--
-- Class CompetenceReportItem as table competence_report_item
--
...
--
-- Class Kindergarden as table kindergarden
--
...
CREATE TABLE "learning_support_plan" (
    ...
    "number" bigint,
    "createdBy" text NOT NULL,
    "specialNeedsTeacher" text,
    "socialPedagogue" text,
    "proffesionalsInvolved" text,
    "strengthsDescription" text,
    "problemsDescription" text,
...
--
-- Class MissedSchoolday as table missed_class
--
...
CREATE TABLE "pupil_book_lending" (
    ...
    "borrowerUserId" bigint,
    "borrowerType" text
);

--
-- Class PupilCommunicationData as table pupil_communication_data
--
...
CREATE TABLE "pupil_data" (
    ...
    "swimmer" text,
    "communicationDataId" bigint,
    "preschoolDataId" bigint,
    "mediaDataId" bigint,
...
--
-- Class PupilMediaData as table pupil_media_data
--
...
--
-- Class PupilPreschoolData as table pupil_preschool_data
--
...
CREATE TABLE "user" (
    ...
    "pupilsAuth" json,
    "schooldayEventsProcessingTeam" text,
    "credit" bigint NOT NULL,
...
--
-- Foreign relations for "learning_support_plan" table
--
...
--
-- Foreign relations for "pupil_media_data" table
--
...
--
-- Foreign relations for "pupil_preschool_data" table
--
